...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"></li>')/*.html('<li class="layui-nav-item layui-this"><a data-url="/main"><i class="seraph icon-github"></i><cite>后台首页2</cite></a></li>')*/
